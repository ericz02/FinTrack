        ...
        {user ? (
          <>
            ...
            <button
              ...
              className="text-sm text-gray-800 bg-slate-400 rounded-full py-4 px-3 hover:bg-slate-500"
            >
              Logout
            </button>
          </>
          ...
          <>
            <Link to="/signup" className="inline-block relative mr-6">
              <span className="text-sm text-gray-800 bg-slate-400 rounded-full py-4 px-3 hover:bg-slate-500">
                Sign Up
              </span>
            </Link>
